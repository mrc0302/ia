...
def main():
            ...
            if base_name and col1.button("Criar Base"):
                try:
                    ...
                    if os.path.exists(base_path):
                        col1.error("Uma base com este nome já existe")
                        return
    ...
    def use_existing_bases():
        ...
        if not bases:
            col1.warning(f"Nenhuma base encontrada em {get_base_dir()}")
            return
    ...
    def delete_knowledge_base():
        ...
        if not bases:
            col1.warning(f"Nenhuma base para deletar em {get_base_dir()}")
            return
